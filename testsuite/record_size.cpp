 ...
 * @version: Fri Sep 12 10:28:33 2021
 * 
                ...
                ipc::buffer *buffer ) 
{
    ...
    if( ipc::buffer::add_channel< ipc::spsc_record >( tls_producer, channel_id, ipc::producer ) == ipc::channel_err )
    {
        return;
    }
                ...
                ipc::buffer *buffer ) 
{
    ...
    if( ipc::buffer::add_channel< ipc::spsc_record >( tls_consumer, channel_id, ipc::consumer ) == ipc::channel_err )
    {
        return;
    }
    ...
    do
    {
        ...
        if( value != count_tracker && ipc::buffer::get_record_size( tls_consumer, record ) != (1 << ipc::block_size_power_two) )
        {
