...
int main()
{
    ...
    //2 blocks 
    const auto ret_code  = ipc::buffer::add_channel< ipc::spsc_record >( fake_tls, channel_id, ipc::producer );
    const auto ret_code2 = ipc::buffer::add_channel< ipc::spsc_record >( fake_tls, channel_id + 1, ipc::producer );
